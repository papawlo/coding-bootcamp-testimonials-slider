...
function setSlidePosition() {
  currentSlide = testimonialsContainerEl.querySelector(
    ".quote:nth-child(" + currentSlideNumber + ")"
  );
  nextSlide = testimonialsContainerEl.querySelector(
    ".quote:nth-child(" + nextSlideNumber + ")"
  );
  previousSlide = testimonialsContainerEl.querySelector(
    ".quote:nth-child(" + previousSlideNumber + ")"
  );

  currentPhoto = testimonialsContainerEl.querySelector(
    ".author-img:nth-child(" + currentSlideNumber + ")"
  );
  nextPhoto = testimonialsContainerEl.querySelector(
    ".author-img:nth-child(" + nextSlideNumber + ")"
  );
  previousPhoto = testimonialsContainerEl.querySelector(
    ".author-img:nth-child(" + previousSlideNumber + ")"
  );
}
